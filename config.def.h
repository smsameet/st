 ...
 */
static char *font = "JetBrainsMono-Bold :pixelsize=16.8:antialias=true:autohint=true";
static char *font2[] = { "CaskaydiaCove Nerd Font :pixelsize=16.8:antialias=true:autohint=true" };
